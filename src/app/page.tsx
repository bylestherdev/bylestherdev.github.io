    ...
    <main className="w-full flex flex-col items-center">
      ...
      <section className="w-full max-w-[1100px] mx-auto px-6 pb-24">
        <div className="bg-[#111827] border-2 border-[#10B981]/40 rounded-3xl p-8 md:p-14 shadow-lg relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 items-center mt-4">
            <div>
            ...
            <div className="space-y-4">
              {[
                { color: "#10B981", text: "Chatbots de WhatsApp e Instagram" },
                { color: "#3b82f6", text: "Calificación automática de leads" },
      ...
      <section className="w-full max-w-[1100px] mx-auto px-6 pb-32">
        <div className="bg-gradient-to-br from-[#111827] to-[#1a2235] border border-[#2d3a4f] rounded-3xl p-10 md:p-16 text-center">
